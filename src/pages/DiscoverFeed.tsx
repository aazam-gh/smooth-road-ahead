        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-14">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-[#6568F4] rounded-lg flex items-center justify-center">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-20 pointer-events-auto">
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 bg-[#6568F4] rounded-full flex items-center justify-center">
